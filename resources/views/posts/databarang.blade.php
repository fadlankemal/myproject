    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{ url('posts')}}">Dashboard</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid mx-3">
                <h1>Data Barang</h1>
                <a href="{{ url('posts/databarang/tambahdata')}}" class="btn btn-success mb-2">Tambah data</a>
                    ...
                    <table class="table table-bordered " style="border: 2px solid; width: 95%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="m-5">{{ $post->rak_barang}}</td>
                                <td>{{ $post->nomor_rak}}</td>
                                <td><a href="{{ url("posts/databarang/$post->id/editdata") }}" class="btn btn-primary">Edit</a></td>
